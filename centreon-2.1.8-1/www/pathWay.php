 ...
 * 
 * SVN : $URL: http://svn.centreon.com/branches/centreon-2.1/www/pathWay.php $
 * SVN : $Id: pathWay.php 10473 2010-05-19 21:25:56Z jmathis $
 * 
 */
	...
	if ($oreon->user->access->page($p)){	
		...
		if (isset($_GET["host_id"]))	{
			...
			echo getMyHostName(htmlentities($_GET["host_id"], ENT_QUOTES));
		}
	}
?>
<hr>