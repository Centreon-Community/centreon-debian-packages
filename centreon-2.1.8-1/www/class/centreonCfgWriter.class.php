 ...
 * 
 * SVN : $URL
 * SVN : $Id: centreonCfgWriter.class.php 10473 2010-05-19 21:25:56Z jmathis $
 * 
 */
...
class CentreonCfgWriter{
	 ...
	 *  Constructor
	 */
	function CentreonCfgWriter($centreon, $file_full_path) {
	...
	private function createFile() {
		if (!$this->fd = fopen($this->file_path, 'w')) {
			echo _("Could not create file") . " : " . $this->file_path . "<br />";
			exit;
		}
	...
	public function createCfgFile() {								
		if (!(strlen($this->buffer)) || !(fwrite($this->fd, $this->buffer))) {
			echo _("Could not write in file") . " : " . $this->file_path . "<br />";
			exit;
		}
		fclose($this->fd);
	}
