 ...
 * 
 * SVN : $URL: http://svn.centreon.com/branches/centreon-2.1/www/include/configuration/configCGI/listCGI.php $
 * SVN : $Id: listCGI.php 10473 2010-05-19 21:25:56Z jmathis $
 * 
 */
	...
	for ($i = 0; $cgi =& $DBRESULT->fetchRow(); $i++) {		
		...
		$elemArr[$i] = array("MenuClass"=>"list_".$style, 
						...
						"RowMenu_status"=>$cgi["cgi_activate"] ? _("Enabled") : _("Disabled"),
