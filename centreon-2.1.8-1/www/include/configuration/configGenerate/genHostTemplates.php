 ...
 * 
 * SVN : $URL: http://svn.centreon.com/branches/centreon-2.1/www/include/configuration/configGenerate/genHostTemplates.php $
 * SVN : $Id: genHostTemplates.php 10473 2010-05-19 21:25:56Z jmathis $
 * 
 */
	...
	$handle = create_file($nagiosCFGPath.$tab['id']."/hostTemplates.cfg", $oreon->user->get_name());
	$DBRESULT =& $pearDB->query("SELECT * " .
								"FROM host " .
								"WHERE host_activate = '1' AND host_register = '0' " .
	...
	write_in_file($handle, html_entity_decode($str, ENT_QUOTES), $nagiosCFGPath.$tab['id']."/hostTemplates.cfg");
	fclose($handle);
	$DBRESULT->free();
	unset($str);
	unset($i);
