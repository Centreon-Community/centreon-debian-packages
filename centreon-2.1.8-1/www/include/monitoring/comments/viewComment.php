 ...
 * 
 * SVN : $URL: http://svn.centreon.com/branches/centreon-2.1/www/include/monitoring/comments/viewComment.php $
 * SVN : $Id: viewComment.php 10473 2010-05-19 21:25:56Z jmathis $
 * 
 */
	if (!isset($oreon))
		exit();
	...
	if ($is_admin) {
		...
		$rq2 =	"SELECT COUNT(*) FROM ".$ndo_base_prefix."comments cmt, ".$ndo_base_prefix."objects obj, centreon_acl " .
				"WHERE obj.name1 IS NOT NULL " .
				"AND obj.name2 IS NULL " .
				"AND obj.object_id = cmt.object_id " .
