 ...
 * 
 * SVN : $URL: http://svn.centreon.com/branches/centreon-2.1/www/include/monitoring/status/ServicesHostGroups/xml/serviceSummaryByHGXML.php $
 * SVN : $Id: serviceSummaryByHGXML.php 10473 2010-05-19 21:25:56Z jmathis $
 * 
 */
	...
	if ($hostgroups) {
	    $rq1 .= " AND hg.hostgroup_id IN (SELECT hostgroup_id FROM ".$ndo_base_prefix."hostgroups WHERE alias LIKE '".$hostgroups."') ";
	}
