 ...
 * 
 * SVN : $URL: http://svn.centreon.com/branches/centreon-2.1/www/include/monitoring/external_cmd/functions.php $
 * SVN : $Id: functions.php 10473 2010-05-19 21:25:56Z jmathis $
 * 
 */
	...
	function acknowledgeService($param){
		...
		if ($actions == true || $is_admin) {
			...
			isset($param['sticky']) && $param['sticky'] == "1" ? $sticky = "2" : $sticky = "1";
			$flg = write_command(" ACKNOWLEDGE_SVC_PROBLEM;".$param["host_name"].";".$param["service_description"].";".$sticky.";".$param["notify"].";".$param["persistent"].";".$param["author"].";".$param["comment"], GetMyHostPoller($pearDB, $param["host_name"]));
			return _("Your command has been sent");
		}
		return NULL;
	}
