 ...
 * 
 * SVN : $URL: http://svn.centreon.com/branches/centreon-2.1/www/include/configuration/configObject/service/DB-Func.php $
 * SVN : $Id: DB-Func.php 10737 2010-07-21 11:28:27Z jmathis $
 * 
 */
						...
						if (isset($maxId["MAX(service_id)"]))	{
							...
							if ($oreon->user->get_version() >= 3){
								...
								while ($sv =& $DBRESULT3->fetchRow()) {
								    ...
								    $macVal = str_replace("/", "#S#", $sv['svc_macro_value']);
