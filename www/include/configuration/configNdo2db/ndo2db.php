 ...
 * 
 * SVN : $URL: http://svn.centreon.com/branches/centreon-2.1/www/include/configuration/configNdo2db/ndo2db.php $
 * SVN : $Id: ndo2db.php 10473 2010-05-19 21:25:56Z jmathis $
 * 
 */
	...
	switch ($o)	{
		...
		case "u" : 
			...
			require_once($path."listNdo2db.php"); 
			break; #Desactivate a Ndo2db CFG
		case "m" : 
