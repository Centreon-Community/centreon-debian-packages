 ...
 * 
 * SVN : $URL: http://svn.centreon.com/branches/centreon-2.1/www/include/configuration/configGenerate/genEscalations.php $
 * SVN : $Id: genEscalations.php 10473 2010-05-19 21:25:56Z jmathis $
 * 
 */
 ...
 * @version $Id: genEscalations.php 10473 2010-05-19 21:25:56Z jmathis $
 ...
 */
	...
	if ($oreon->CentreonGMT->used() == 1) {	
		...
		while ($escalation =& $DBRESULT->fetchRow()) {
			...
			$strTemp = null;
			while ($hg =& $DBRESULT2->fetchRow()) {
				if ($gbArr[3][$hg["hg_id"]] && isset($hgHostGenerated[$hg["hg_name"]])) {
