 ...
 * 
 * SVN : $URL: http://svn.centreon.com/branches/centreon-2.1/www/include/configuration/configObject/host/listHost.php $
 * SVN : $Id: listHost.php 10750 2010-07-23 10:04:47Z jmathis $
 * 
 */
	...
	for ($i = 0; $i < count($elemArr); $i++)	{
		...
		if (isset($pattern) && strstr($elemArr[$i]["RowMenu_name"], $pattern))
