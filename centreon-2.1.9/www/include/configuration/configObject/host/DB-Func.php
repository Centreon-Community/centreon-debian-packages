 ...
 * 
 * SVN : $URL: http://svn.centreon.com/branches/centreon-2.1/www/include/configuration/configObject/host/DB-Func.php $
 * SVN : $Id: DB-Func.php 10735 2010-07-21 11:23:14Z jmathis $
 * 
 */
						 ...
						 */
						 if ($oreon->user->get_version() >= 3)
						 {
							...
							while ($hst =& $DBRESULT3->fetchRow()) {
								...
								$hst['host_macro_value'] = str_replace("/", "#S#", $hst['host_macro_value']);
								$hst['host_macro_value'] = str_replace("\\", "#BS#", $hst['host_macro_value']);
