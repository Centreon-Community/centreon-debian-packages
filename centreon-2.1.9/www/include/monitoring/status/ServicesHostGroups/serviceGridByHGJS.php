 ...
 * 
 * SVN : $URL: http://svn.centreon.com/branches/centreon-2.1/www/include/monitoring/status/ServicesHostGroups/serviceGridByHGJS.php $
 * SVN : $Id: serviceGridByHGJS.php 10473 2010-05-19 21:25:56Z jmathis $
 * 
 */
...
function goM(_time_reload,_sid,_o){
	...
	var _addrXML = "./include/monitoring/status/ServicesHostGroups/xml/serviceGridByHGXML.php?"+'&sid='+_sid+'&search='+_search+'&search_type_host='+_search_type_host+'&search_type_service='+_search_type_service+'&num='+_num+'&limit='+_limit+'&sort_type='+_sort_type+'&order='+_order+'&date_time_format_status='+_date_time_format_status+'&o=<?php echo $obis?>&p='+_p+'&time=<?php print time(); ?>';
