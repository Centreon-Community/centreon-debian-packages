...
####################################################################
#
# SVN: $URL: http://svn.centreon.com/branches/centreon-2.1/install.sh $
# SVN: $Rev: 9940 $
# SVN: $Author: jmathis $
# SVN: $Date: 2010-02-12 18:02:50 +0100 (Fri, 12 Feb 2010) $
# SVN  $Id: install.sh 9940 2010-02-12 17:02:50Z jmathis $
#
#
# Todo list
# - upgrade process 
